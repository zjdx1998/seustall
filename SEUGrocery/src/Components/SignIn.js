...
export default class SignIn extends Component {
  ...
  identifyingCodeLoginButton = () => {
    ...
    this.setState(state => {
      if (this.state.stateNum == 1) {return state2;}
      if (this.state.stateNum == 2) {return state1;}
    });
  };
      ...
      <ImageBackground
        ...
        <View style={styles.container}>
          <View style={[styles.inputStyle, styles.numberInputStyle]}>
            <Icon name={'mobile-phone'} type={'font-awesome'} color={'grey'} />
            <TextInput
          ...
          <View
            ...
            <Icon name={'lock'} type={'font-awesome'} color={'grey'} />
            <TextInput
