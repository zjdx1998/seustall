        ...
        return (
            <TouchableOpacity
                ...
                <View style={styles.block}>
                    <ImageBackground style={{ flex: 1, height:150 ,flexDirection: 'row'}}
                                     source={this.props.isSold ? require('../Common/img/isSold.png'):require('../Common/img/notSold.png')}>
                    <Image source={this.props.image} style={{width: 150, height: 150}} />
                    <View style={styles.textBlock}>
                        <Text numberOfLines={1} style={styles.name}>{this.props.name}</Text>
                        <Text numberOfLines={1} style={styles.howNewAndCampus}>{this.props.howNew}成新</Text>
                        <Text numberOfLines={1} style={styles.howNewAndCampus}>{this.props.campus}</Text>
