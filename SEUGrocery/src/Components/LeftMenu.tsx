...
class LeftMenu extends Component {
  ...
  render() {
    const imgUrl =
      this.props.navigation.state.routes[0].routeName === 'home'
        ? ImagesUrl.bgOne
        : this.props.navigation.state.routes[0].routeName === 'page1'
        ? ImagesUrl.bgTwo
        : ImagesUrl.bgThree;

    return (
      <View style={styles.container}>
        <Image source={imgUrl} style={styles.imgBg} />
        <View style={styles.profile}>
          <View style={styles.group}>
            <View style={styles.imgWrapper}>
              <Image
                source={ImagesUrl.profilePic}
                style={styles.profilePic}
                resizeMode={'contain'}
              />
            </View>
            <Icon name={'gear'} style={styles.settings} />
          </View>
