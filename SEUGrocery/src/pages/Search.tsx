        ...
        <Header
          ...
          centerComponent={
            <View style={styles.container_row}>
              <View style={[styles.mode, {backgroundColor: this.state.sgbc}]}>
                <Text
                  style={[
                    styles.text,
              ...
              <View style={[styles.mode, {backgroundColor: this.state.subc}]}>
                <Text
                  style={[
                    styles.text,
                  ...
                  if (index > 9) {
                    ...
                    return (
                      <TouchableOpacity
                        ...
                        key={index}>
                        <Text numberOfLines={1} style={styles.searchLabelText}>
                          {item}
                        </Text>
                      </TouchableOpacity>
                    );
