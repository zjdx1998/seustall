      ...
      return (
        <View style={{flexDirection: 'row'}}>
          <TouchableOpacity style={styles.buttonStyle} onPress={() => {}}>
            <Text style={styles.textStyle}>修改信息</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.buttonStyle} onPress={() => {}}>
      ...
      return (
        <View style={{flexDirection: 'row'}}>
          <TouchableOpacity
            ...
            <Text style={[styles.textStyle, {color: 'white'}]}>我想购买</Text>
          </TouchableOpacity>
          <TouchableOpacity
            ...
            <Text style={styles.textStyle}>联系卖家</Text>
          </TouchableOpacity>
        </View>
      );
    }
      ...
      <View style={{height: SP.HB(100)}}>
        ...
        <EditView
          ...
          ensureCallback={() => {
            ...
            postData('http://hanyuu.top:8080/user/chat/push', data).then(
              response => {
