            ...
            >
                    ...
                    {this.state.orderList.map((i,j)=>{
                        return(
                            <View style={styles.orderContainer}>
                                <Text style={{alignSelf:'center',fontSize:20}}>交易请求</Text>
                                ...
                                <View style={{flexDirection:'row'}}>
                                    <Button
                                        ...
                                        onPress={()=>{
                                            ...
                                            postData('http://hanyuu.top:8080/user/chat/push',data1)
                                                .then(response=>{
                                            ...
                                            postData('http://hanyuu.top:8080/user/want/delete',data)
                                                .then(res=>{
                                    ...
                                    <Button
                                        ...
                                        onPress={()=>{
                                            ...
                                            postData('http://hanyuu.top:8080/item/order',data)
                                                .then(response=>{
                ...
                <View style={{top:-SP.HB(3)}}>
                    ...
                    {this.state.refuseList.map((i,j)=>{
                        return(
                            <View style={styles.orderContainer}>
                                <Text style={{alignSelf:'center',fontSize:20}}>订单被拒</Text>
                                <Text style={{color:'#cc6699'}}>{i.user.username} </Text>
                                <Text>拒绝了关于</Text>
                                <Text style={{color:'#cc6699'}}>{i.item.title} </Text>
                                <Text>的交易请求</Text>
                ...
                <View style={{top:-SP.HB(3)}}>
                    {this.state.agreeList.map((i,j)=>{
                        return(
                            <View style={styles.orderContainer}>
                                <Text style={{alignSelf: 'center', fontSize: 20}}>等待收货</Text>
                                <Text style={{color:'#cc6699'}}>{i.user.username} </Text>
                                <Text>同意了关于</Text>
                                <Text style={{color:'#cc6699'}}>{i.item.title} </Text>
                                <Text>的交易请求</Text>
                                <View style={{flexDirection:'row'}}>
                                    <Button
                                        ...
                                        onPress={()=>{
                                            ...
                                            postData('http://hanyuu.top:8080/item/trade',data)
                                                .then(res=>{
                                                    let data1={
                                                        token:this.state.token,
                                                        to:i.message.from,
                                        ...
                                        onPress={()=>{
                                           ...
                                           postData('http://hanyuu.top:8080/user/want/delete',data1)
                                                .then(res=>{
                                                    console.log('delete',res);
                                                    this.getInfo();
                                                })
