        ...
        return (
            <View style={styles.baseContainer}>
                ...
                <ActionButton
                    ...
                    size={70}
                    renderIcon={() => (
                        <View style={styles.actionButtonView}><Icon name="pencil-alt" style={{color: '#ffffff'}}
                                                                    size={30}/>
                            <Text style={{color: '#ffffff', fontSize: 12, alignSelf: 'center'}}>发 布</Text>
                        </View>)}
                >
                    <ActionButton.Item buttonColor='#e6b6ce' title="我想卖"
                                       textContainerStyle={{backgroundColor: '#ffffff', opacity: 0.75}}
                                       textStyle={{color: '#7d2954'}} onPress={() => {
                    }}>
                        <Icon name="coins" style={styles.actionButtonIcon} color={'#ffffff'} size={30}/>
                    </ActionButton.Item>
                    <ActionButton.Item buttonColor='#d582ac' title="我想买"
                                       textContainerStyle={{backgroundColor: '#ffffff', opacity: 0.75}}
                                       textStyle={{color: '#7d2954'}} onPress={() => {
                    }}>
                        <Icon name="shopping-basket" style={styles.actionButtonIcon} color={'#ffffff'} size={30}/>
                    </ActionButton.Item>
                </ActionButton>
            </View>
        );
