                        ...
                        <View style={styles.txtArea}>
                            ...
                            <View style={styles.viewId}>
                                <View style={styles.viewIfId}>
                                    <Text style={{color:'#cc6688',fontSize:10,padding:1}}>已认证</Text>
                                </View>
                                <Text style={styles.txtId}>1234567</Text>
                            </View>
                            <Text numberOfLines={2} style={styles.txtInfo}>这里是个人简介How can you benefit with a certificate from the American Certification Institute</Text>
                            <View style={styles.viewEdit}>
                                <Icon name='pencil-square-o' style={{color:'#cc6699'}} size={15}/>
